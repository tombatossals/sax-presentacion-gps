function map() {
    ...
    legend.innerHTML='<div class="legend" style="background: white; padding: 5px; font-size: 10px;"><ul><li><img src="img/map/yellow.png" /> Enlaces funcionando</li><li><img src="img/map/green.png" /> Troncales entre supernodos</li><li><img src="img/map/blue.png" /> Enlaces en pruebas</li><li><img src="img/map/dot.png" /> Nodos de usuario</li><li><img src="img/map/star.png" /> Supernodos</li></ul></div>';
    legend.index = 1;
